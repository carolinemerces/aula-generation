programa
{
	...
	funcao inicio()
	{
		 ...
		 * suas atividades, se o índice crescer para 0,4 as indústrias do 1º e 2º grupo são intimadas 
		 ...
		 */
		 ...
		 leia(indice);
		 escreva("Insira de 1 a 3 o grupo a qual o indíce pertence: ")
		 leia(grupo);
		 caso 1
		 
		 se (indice<=0.05 e indice>=0.25){
		 	escreva("Índice dentro dos padrões aceitáveis.")
		 }
		 senao se (indice>=0.26 e indice<=0.29){
		 	escreva("Índice acima dos padrões aceitáveis. Continuar monitorando.")
		 }
		 senao se (indice>=0.3){
		 	escreva("Índice muito acima dos padrões aceitáveis. ")
		 }
	}
}
/* $$$ Portugol Studio $$$ 
